...
const CoupleWithHeartWomanWomanMediumDarkSkinToneMediumLightSkinTone = ({ size, rem }: {
  size: number | string,
  rem?: boolean
}) => {
...
export default CoupleWithHeartWomanWomanMediumDarkSkinToneMediumLightSkinTone
