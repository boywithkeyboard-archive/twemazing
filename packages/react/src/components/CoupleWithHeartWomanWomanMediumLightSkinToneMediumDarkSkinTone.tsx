...
const CoupleWithHeartWomanWomanMediumLightSkinToneMediumDarkSkinTone = ({ size, rem }: {
  size: number | string,
  rem?: boolean
}) => {
...
export default CoupleWithHeartWomanWomanMediumLightSkinToneMediumDarkSkinTone
